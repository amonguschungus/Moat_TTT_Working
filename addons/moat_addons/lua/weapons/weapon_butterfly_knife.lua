...
if CLIENT then
   ...
   SWEP.Icon = "vgui/entities/csgo_butterfly_damascus"
...
local sound_single = Sound("csgo_ButterflyKnife.swingair")
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) or tr_main.HitWorld then
      ...
      self.Weapon:EmitSound("csgo_ButterflyKnife.hitwall")
      if not (CLIENT and (not IsFirstTimePredicted())) then
         ...
         if hitEnt:IsPlayer() or hitEnt:GetClass() == "prop_ragdoll" then
            ...
            self.Weapon:EmitSound("csgo_ButterflyKnife.hitflesh")
