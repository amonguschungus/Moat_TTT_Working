...
moat.discord = {}
moat.discord.clientID = ""
moat.discord.clientSecret = ""
moat.discord.botToken = ""
moat.discord.botClientID = ""
moat.discord.botClientSecret = ""
moat.discord.users = {}
...
function discord_(db)
    ...
    net.Receive("discord.OAuth",function(l,ply)
        ...
        HTTP({
            method = "POST",
            url = "https://discordapp.com/api/v6/oauth2/token?" .. http.UrlEncode({
                ...
                if s == 200 then
                    ...
                    AuthedGet(token,"/users/@me",function(code,body)
                        if code == 200 then
                            ...
                            HTTP({
                                method = "PUT",
                                url = "https://discordapp.com/api/v6/guilds/986308325438287932/members/" .. body.id,
                                headers = {
